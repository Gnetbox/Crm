...
<script type="text/javascript">
	$(function(){
				...
				$.ajax({
					...
					success:function(data){
						$.each(data,function (index,element){
							html +=  '<tr>';
							html +=  '<td><input type="radio" value="'+element.id+'" name="check"/></td>';
		...
		$("#submitActivity").click(function (){
			...
			//获取市场活动名字
			let text = $("input[name='check']:checked").parent().parent().children("td").eq(1).text();
			//给市场活动源 格子设置文本内容
			$("#activity").val(text);
...
<body>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tran" action="workbench/clue/change.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" id="tradeName" name="tradeName" value="动力节点-">
		  </div>
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
